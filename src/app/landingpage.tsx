// // src/app/page.tsx - WOW LANDING PAGE
// "use client";
...
//         <div className="absolute top-1/2 left-1/2 w-48 h-48 bg-blue-500/5 rounded-full blur-3xl animate-pulse delay-2000"></div>
//       </div>
...
//             <div className="inline-flex items-center gap-2 px-4 py-2 bg-lightGreen/10 border border-lightGreen/30 rounded-full text-lightGreen text-sm font-medium mb-6 animate-fade-in">
...
//               Your
//               <span className="bg-gradient-to-r from-lightGreen to-green-400 bg-clip-text text-transparent">
//                 {" "}AI-powered{" "}
//               </span>
//               Snippet Brain
//             </h1>
            
//             <p className="text-xl lg:text-2xl text-textSecondary mb-8 max-w-2xl animate-slide-up delay-300">
...
//               <Link
//                 href="/snippets"
//                 className="group px-8 py-4 bg-gradient-to-r from-lightGreen to-green-400 text-gray-900 font-bold rounded-lg hover:shadow-lg hover:shadow-lightGreen/25 transition-all duration-300 flex items-center justify-center gap-2"
//               >
...
//             {/* Stats */}
//             <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 animate-slide-up delay-700">
...
//           {/* Right Content - Animated Code Preview */}
//           <div className="relative animate-slide-up delay-1000">
...
//             {/* Floating Elements */}
//             <div className="absolute -top-4 -right-4 w-16 h-16 bg-lightGreen/20 rounded-full flex items-center justify-center animate-bounce">
//               <Zap className="w-8 h-8 text-lightGreen" />
//             </div>
//             <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-purple-500/20 rounded-full flex items-center justify-center animate-pulse">
...
//   );
// }
// src/app/page.tsx - Optimized landing page
"use client";
import { useState, useEffect } from 'react';
import Link from 'next/link';
import { Code, Search, Users, Star, ArrowRight, Play, Sparkles, Terminal, Zap } from 'lucide-react';
