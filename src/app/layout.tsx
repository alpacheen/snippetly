...
export const metadata: Metadata = {
  ...
  description:
    "Discover, save and share code snippets. The developer's go-to code library with AI-powered search and explanations.",
  keywords: [
    "code snippets",
    "programming",
    "developer tools",
  ...
  openGraph: {
    ...
    description:
      "Discover, save and share code snippets. The developer's go-to code library.",
    images: [
      {
...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body
        className="flex flex-col min-h-screen bg-primary text-text antialiased"
