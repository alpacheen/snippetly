...
//         className="w-full border px-4 py-2 rounded-lg bg-primary text-text border-textSecondary focus:border-lightGreen focus:outline-none"/>
//       <TabGroup
...
//   );
// }
// src/app/components/TabsFilter.tsx
"use client";
          ...
          {tabs.map((tab) => (
            <Tab
              ...
              className={({ selected }) =>
                `px-4 py-2 font-medium text-sm transition-colors ${
                  selected
                    ? "border-b-2 border-lightGreen text-lightGreen"
                    : "text-textSecondary hover:text-lightGreen"
                }`
              }
            >
              {tab}
          ...
          {languages.map((language) => (
            <button
              ...
              className={`px-3 py-1 rounded-lg text-sm transition-colors ${
                currentLanguage === language
                  ? "bg-lightGreen text-primary"
                  : "bg-textSecondary text-primary hover:bg-lightGreen/20"
              }`}
            >
              {language}
            </button>
